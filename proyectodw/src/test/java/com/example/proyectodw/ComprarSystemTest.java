...
public class ComprarSystemTest {
    ...
    /**
     * CP 7.1
     * Corresponde al CU-007 Comprar Producto
     *Se realiza una compra de un producto especifico
     * 
     * 
     */
    @Test
    void cp7_1(){
        ...
        String resultado = "";
        try{
            this.browser.get(this.baseUrl + "/dashboard/usuario/5/navegacion/4/estrella/2/planeta/6/planeta-producto/10/comprar/13");
