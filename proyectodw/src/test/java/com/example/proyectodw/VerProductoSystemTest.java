...
public class VerProductoSystemTest {
    ...
    /**
     * CP 6.1
     * Corresponde al CU-009 Ver Producto
     * Selecciona un producto de la lista de productos y muestra su informacion
     * 
     * 
     */
    @Test
    void cp6_1(){
        String url = this.baseUrl + "/dashboard/usuario/5/navegacion/4/estrella/2/planeta/6/planeta-producto/10/comprar/13";
       
        try{
            this.browser.get(this.baseUrl + "/dashboard/usuario/5/navegacion/4/estrella/2/planeta/6");
            ...
            liProductos.get(2).click();
            wait.until(ExpectedConditions.presenceOfElementLocated(By.id("btnComprar")));
            WebElement btnComprar = this.browser.findElementById("btnComprar");
            btnComprar.click();
            ...
            assertEquals(url, this.browser.getCurrentUrl()); 
